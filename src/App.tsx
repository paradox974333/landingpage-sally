        ...
        <section className="w-full bg-[#121317] py-12 md:py-20 px-4 border-t border-zinc-900 flex flex-col items-center justify-center">
            <div className="max-w-5xl mx-auto text-center">
                ...
                <div className="relative w-full flex justify-center">
                   ...
                   <img
  src="lab.png"
  className="w-[56px] md:w-[165px] h-auto object-contain opacity-80 hover:opacity-100 transition-opacity duration-500"
/>
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <img
                src="logo.png"
                alt="Imperial X Logo"
                 className="w-[56px] md:w-[100px] h-auto object-contain opacity-80 hover:opacity-100 transition-opacity duration-500"
              />
