...
// Note: We are defining Carousel locally below to apply the specific size/button changes
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          // Aspect Ratio adjusted slightly for "Bigger" feel
...
function Carousel({ slides }) {
  ...
  // SIZE INCREASED: 95vw width, max 1600px
...
function WhatSallyCanDo() {
  ...
  return (
    <section id="capabilities" className="w-full bg-[#121317] py-16 md:py-24 px-4 sm:px-6">
...
function HowSallyWorks() {
  ...
  return (
    <>
      ...
      <section id="architecture" className="w-full bg-[#121317] py-16 md:py-24 px-4 sm:px-6 border-t border-zinc-900">
